...
val defaultManagerPackageName = if (isPrBuild) "io.github.qaq77w.sukisu.anime.pr" else "io.github.qaq77w.sukisu.anime"
val defaultManagerName = if (isPrBuild) "SukiSU Anime PR" else "SukiSU Anime"
